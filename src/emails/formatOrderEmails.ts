export const formatOrderEmail = (lineItems: any, totalSessionAmount: number | null) => {
  return `
      ...
      More order information available in admin dashboard.
      </p>
      </div>`;
};
